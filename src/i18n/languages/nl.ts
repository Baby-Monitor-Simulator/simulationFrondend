export default {
  ...
  form: {
    ...
    //Error messages
    fileInputErrorText:
      "Ongeldig bestand. Lever een handmatig geëxporteerd MatLab-bestand in.",
  ...
  header: {
    ...
    hoverExplanation:
      "Houd muis over de onderdelen hieronder om erachter te komen hoe de applicatie werkt.",
    languageChangeTitle: "Taal veranderen",
    languageChangeDescription:
      "Je kunt de taal veranderen tussen Nederlands en Engels.",
  ...
  manual: {
    ...
    scenario: {
      ...
      description: "Dit is een voorbeeld voor de scenario pagina.",
    },
    dashboard: {
      title: "Dashboard titel",
      description: "Dit is een beschrijving voor de dashboard page.",
    },
    admin: {
      title: "Admin titel",
      description: "Dit is een beschrijving voor de administratie pagina.",
    },
    newLobby: {
      title: "Maak een nieuwe lobby",
      description: "Hier kun je een nieuwe simulatie lobby aanmaken.",
    },
    joinLobby: {
      title: "Deelnemen aan lobby",
      description: "Hier kan je deelnemen aan een bestaande lobby.",

      leaveTitle: "Verlaat lobby",
      leaveDescription: "Verlaat de huidige lobby.",
    },
    notFound: {
      title: "Nier gevonden",
      description: "Er is geen handleiding gevonden voor deze pagina.",
    },
  },
  lobby: {
  ...
  scenario: {
    ...
    errors: {
      loadFailed:
        "Er is een fout opgetreden bij het ophalen van de scenario's.",
    },
  },
  results: {
    title: "Resultaten",
