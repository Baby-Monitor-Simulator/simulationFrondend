export default {
  ...
  form: {
    ...
    //Error messages
    fileInputErrorText:
      "Invalid file. Please supply a manually exported MatLab file.",
  ...
  manual: {
    manualTitle: "Manual",
    hoverExplanation:
      "Hover over items below to learn how this application works.",
    ...
    results: {
      title: "Result Title",
      description: "This is a description for the results page.",

      graphTitle: "Reading Graph",
      graphDescription: "This graph shows how blablabla.",
    },
    scenario: {
      title: "Scenario Title",
      description: "This is a description for the scenario page.",
    },
    dashboard: {
      title: "Dashboard Title",
      description: "This is a description for the dashboard page.",
    },
    admin: {
      title: "Admin Title",
      description: "This is a description for the admin page.",
    },
    newLobby: {
      title: "Create new lobby",
      description: "You can create a new lobby here.",
    },
    joinLobby: {
