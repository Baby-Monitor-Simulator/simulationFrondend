    ...
    <div class="container">
        <v-navigation-drawer theme="dark" :width="275" :disable-resize-watcher="true" :disable-route-watcher="true" :floating="true" :permanent="true">
            <v-list>
                ...
                <v-sheet class="ma-1 pa-2">
                    <v-btn :elevation="hoverStore.export ? 16 : 2" :color="hoverStore.export ? '#00FF00' : 'white'" block
                        prepend-icon="mdi-download" title="Export Data" @click="null" variant="outlined">Export Data</v-btn>
                </v-sheet>
                <v-divider></v-divider>
